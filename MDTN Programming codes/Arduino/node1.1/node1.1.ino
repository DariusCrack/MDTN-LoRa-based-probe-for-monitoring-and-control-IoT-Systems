...
const int controllable_gpios[] = {33, 15, 16, 17, 18, 19, 21, 22, 23, 25, 26, 27, 32, 34, 35, 36, 39};
...
void taskUARTControl(void *pvParameters) {
  ...
  while (true) {
    ...
    //}
    delay(100);  // Wait 5 seconds before reading again
  }
  yield();
}
...
float readInternalTemperature() {
  ...
  int raw = analogRead(12);  // ADC1 Channel 4 (GPIO34)
